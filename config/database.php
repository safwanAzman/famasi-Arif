...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'branch_98' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL_98'),
            'host' => env('DB_HOST_98', 'localhost'),
            'port' => env('DB_PORT_98', '1433'),
            'database' => env('DB_DATABASE_98', 'forge'),
            'username' => env('DB_USERNAME_98', 'forge'),
            'password' => env('DB_PASSWORD_98', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
        ...
        'branch_99' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL_99'),
            'host' => env('DB_HOST_99', 'localhost'),
            'port' => env('DB_PORT_99', '1433'),
            'database' => env('DB_DATABASE_99', 'forge'),
            'username' => env('DB_USERNAME_99', 'forge'),
            'password' => env('DB_PASSWORD_99', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
